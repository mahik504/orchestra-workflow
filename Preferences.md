...
Use on marketing / hero / portfolio surfaces. Skip on dense tools and dashboards except a **smooth loader**.
...
## Thinking (how I decide)

- I guide in human language. Cursor Plans. I follow. Do not dump a spec and disappear.
- Weak on frontend UI/UX, security, CI/CD. Backend from agents is already decent.
- Unique product look matters. Generic AI SaaS is a fail.
- Shipped public repos beat four unfinished apps.
...
- Official Expo skills (curated).
- **Strix** on **our** apps when Docker works. Not a third-party pentest toy.
- **SkillUI** CLI on demand (`npx skillui`) when Plan names **one** live URL to echo.
