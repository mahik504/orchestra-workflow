# Wire Orchestra 3.3.1 onto chosen hosts. No secrets. No skills add --all.
#
...
function Resolve-Hosts([string]$raw) {
    ...
    Write-Host "Which hosts should use Orchestra 3.3.1?"
    Write-Host "  [1] Cursor"
...
Write-Host ""
Write-Host "Restart the IDE. Next chat in this workspace uses Orchestra 3.3.1 (AGENTS.md)."
