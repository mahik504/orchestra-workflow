---
name: orchestra-ship
description: End of a complete project. Remind GitHub push and LinkedIn. Draft ship-post.md. Internship/career memory. Never fake contribution graphs.
---

# Ship + career

When a project is **done enough to show** (assignment submitted, MVP usable, paper-ready README) **or** a DSA session produced solutions worth pushing:

1. Stop. Remind: `git push`, then LinkedIn, then Instagram if we drafted a caption.
